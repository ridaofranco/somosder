...
export default function ManchesterCityTrophyTourPage() {
  const projectStats = [
    { icon: Users, label: "Fanáticos", value: "2,000+", color: "text-[#FF5C00]" },
    { icon: Globe, label: "Branding", value: "Mundial", color: "text-[#333333]" },
    { icon: Target, label: "Activaciones", value: "Múltiples", color: "text-[#FF5C00]" },
    { icon: Award, label: "Producción", value: "Integral", color: "text-[#333333]" },
  ]
      ...
      <section className="py-4 bg-white border-b">
        <div className="container px-4 md:px-6">
          <div className="flex items-center text-sm text-[#333333]">
            ...
            <span className="mx-2">/</span>
            <span className="text-[#333333] font-medium">Manchester City Trophy Tour</span>
          </div>
        </div>
      </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  <Badge className="bg-white text-[#FF5C00]">Deportivo</Badge>
                  <Badge className="bg-white/20 text-white">Branding Mundial</Badge>
                  <Badge className="bg-white/20 text-white">Producción Integral</Badge>
                </div>

                <h1 className="text-4xl md:text-6xl font-bold mb-6">
                  Manchester City <span className="text-yellow-300">Trophy Tour</span>
                </h1>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                  ...
                  <div className="text-center">
                    <div className="text-3xl font-bold text-yellow-300">Mundial</div>
                    <div className="text-sm opacity-80">Branding</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-yellow-300">Múltiples</div>
                    <div className="text-sm opacity-80">Activaciones</div>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-yellow-300">Integral</div>
                ...
                <div className="flex flex-wrap gap-6 text-sm">
                  ...
                  <div className="flex items-center">
                    <Monitor className="w-4 h-4 mr-2 text-yellow-300" />
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#333333] mb-4">
                Producción <span className="text-[#FF5C00]">Emblemática</span>
              </h2>
      ...
      <section className="py-16 bg-white">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#333333] mb-4">
                Producción <span className="text-[#FF5C00]">Integral</span>
              </h2>
              <p className="text-xl text-[#333333]">
      ...
      <section className="py-16 bg-[#F0F0F0]">
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-[#333333] mb-4">
                Desarrollo <span className="text-[#FF5C00]">Emblemático</span>
              </h2>
              <p className="text-xl text-[#333333]">De la conceptualización creativa al impacto mediático</p>
            </div>
                ...
                >
                  <CardHeader className="pb-4">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-sm text-[#333333] opacity-70">{phase.duration}</span>
                    </div>
                    <CardTitle className="text-lg text-[#333333]">{phase.phase}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <ul className="space-y-2">
                      {phase.tasks.map((task, taskIndex) => (
                        <li key={taskIndex} className="flex items-start text-sm">
                          ...
                          <span className="text-[#333333]">{task}</span>
                        </li>
                      ))}
                    </ul>
                  </CardContent>
        ...
        <div className="container px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-[#333333]">Impacto real de la producción emblemática</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">2,000+ Fanáticos Reunidos</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          En atmósfera de branding deportivo mundial
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">Activaciones Múltiples Simultáneas</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Coordinación perfecta con equipos especializados
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      <Star className="w-5 h-5 text-[#FF5C00] mr-3 mt-0.5" />
                      <div>
                        <div className="font-semibold text-[#333333]">Experiencia Inmersiva Lograda</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Conexión auténtica con identidad Manchester City
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">Producción Integral Exitosa</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Desde conceptualización hasta ejecución completa
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <Card className="hover:shadow-xl transition-all duration-300 border-2 hover:border-[#FF5C00]">
                <CardHeader>
                  <CardTitle className="flex items-center">
                    <Award className="w-5 h-5 text-[#FF5C00] mr-2" />
                    Impacto Mediático
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-start">
                      <Globe className="w-5 h-5 text-[#FF5C00] mr-3 mt-0.5" />
                      <div>
                        <div className="font-semibold text-[#333333]">Cobertura Medios Principales</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Impacto mediático significativo nacional
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">Branding Deportivo Clase Mundial</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Identidad global adaptada al contexto argentino
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">Referencia Producción Deportiva</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Estableció estándar para eventos deportivos
                        </div>
                      </div>
                    </div>
                    <div className="flex items-start">
                      ...
                      <div>
                        <div className="font-semibold text-[#333333]">Experiencia Fan Auténtica</div>
                        <div className="text-sm text-[#333333] opacity-70">
                          Conexión genuina con cultura Manchester City
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              <h2 className="text-3xl md:text-5xl font-bold mb-6">
                Creemos tu experiencia <span className="text-yellow-300">deportiva emblemática</span>
              </h2>
